        ...
        <div>
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Форма отправки статьи</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                ...
                <div class="form-group">
                  <label>Автор</label>
                  <input type="text" class="form-control" id="author" name="author" placeholder="Введите имя автора ...">
                </div>
                <div class="form-group">
                  <label>Должность</label>
                  <input type="text" class="form-control" id="dolz" name="dolz" placeholder="А также его должность ...">
                </div>
                                <div class="form-group">
                  <label>Номер журнала</label>
                  <input type="text" class="form-control" id="no" name="no" placeholder="Введите номер журнала ...">
                </div>
                              <div class="form-group">
    ...
    $('.date').datepicker({  
       ...
       format: 'yyyy-mm-dd'
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="short" name="short" placeholder="Введите сопроводительный текст ..."></textarea>
                </div>
                <div class="form-group">
                  <label>Содержание</label>
                  <textarea class="form-control" rows="3" placeholder="Содержание статьи ..." id="content" name="content"></textarea>
                </div>
                               <div class="form-group">
                  <label>Выберите рубрику</label>
                  <select class="form-control" id="rubrikas" name="rubrikas">
                    @foreach($rubrikas as $rubrika)
                    <option value="{!! $rubrika->id !!}">{!! $rubrika->name !!}</option>
                    @endforeach
                  </select>
                </div>
                                <div class="form-group">
